<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="OperationsOpsLive2.aspx.cs" Inherits="PatrolWebApp.Operations2" %>
...
<asp:Content ID="OperationsContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript"> //websock live caller id stuff
        ...
        var ws = new RobustWebSocket('ws://' + window.location.origin.replace("http://", "") + ':8080/CallerServer', null, {
            ...
            shouldReconnect: function (event, ws) {
                ...
                return ws.reconnects <= 200000 && 0//return [0, 3000, 3000, 3000, 3000][ws.attempts]//return ws.reconnects <= 2000 && 0;
            },
        ...
        ws.addEventListener('message', function (event) {
            ...
            //LiveCaller_AwahlMappingID //later
            var LiveCaller_CallerID_Label = ASPxClientLabel.Cast("LiveCaller_CallerID_Label");
            var LiveCaller_MilNumberName_Label = ASPxClientLabel.Cast("LiveCaller_MilNumberName_Label");
            ...
            document.getElementById("LiveCaller_AwahlMappingID").value = msgsplitted[2];
            LiveCaller_CallerID_Label.SetText(msgsplitted[3]);
            LiveCaller_MilNumberName_Label.SetText(msgsplitted[6]);
            LiveCaller_HandHeld_Label.SetText(msgsplitted[4]);
            LiveCaller_Patrol_Label.SetText(msgsplitted[5]);
            var patrolStateID = msgsplitted[7];
            //hide all buttons
    ...
    <asp:UpdatePanel ID="UpdatePanel" runat="server" UpdateMode="Always">
        <ContentTemplate>
                    ...
                    <td style="width: 65%; vertical-align: top;">
                        <dx:ASPxGridView ID="OpsLiveGrid" runat="server" ClientInstanceName="OpsLiveGrid"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataComboBoxColumn FieldName="RankID" VisibleIndex="6" Caption="الرتبه" Settings-AllowFilterBySearchPanel="False" Settings-AllowHeaderFilter="True">
                                    <PropertiesComboBox TextField="Name" ValueField="RankID" DataSourceID="OpsRanksDataSource"></PropertiesComboBox>
                                ...
                                <dx:GridViewDataComboBoxColumn FieldName="PatrolRoleID" VisibleIndex="8" Caption="المسؤولية" Settings-AllowFilterBySearchPanel="False" Settings-AllowHeaderFilter="True">
                                    <PropertiesComboBox TextField="Name" ValueField="PatrolRoleID" DataSourceID="OpsPatrolRoleDataSource"></PropertiesComboBox>
                                    <Settings AllowAutoFilter="False" />
                                    <SettingsHeaderFilter Mode="CheckedList"></SettingsHeaderFilter>
                                </dx:GridViewDataComboBoxColumn>
                                ...
                                <dx:GridViewDataComboBoxColumn FieldName="PatrolPersonStateID" VisibleIndex="14" Caption="الحالة" Settings-AllowFilterBySearchPanel="False" Settings-AllowHeaderFilter="True">
            ...
            <%--Live Caller PopUp--%>
            <dx:ASPxPopupControl ID="LiveCaller_PopUp" AllowDragging="true" ClientInstanceName="LiveCaller_PopUp" runat="server" Theme="DevEx" PopupVerticalAlign="TopSides" PopupHorizontalAlign="LeftSides" CloseAnimationType="Slide" PopupAnimationType="Slide" CloseOnEscape="True">
                <ContentCollection>
                        ...
                        <asp:Panel ID="LiveCaller_Panel" runat="server" Width="100%">
                            ...
                            <table style="width: 100%; font-size: medium">
                                ...
                                <tr>
                                    <td>الاسم</td>
                                    <td>
                                        <dx:ASPxLabel ID="LiveCaller_MilNumberName_Label" ClientInstanceName="LiveCaller_MilNumberName_Label" runat="server" Theme="DevEx" Text="" Font-Size="Medium" />
                                    </td>
                                </tr>
            ...
            <asp:SqlDataSource ID="OpsLiveDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:PatrolsConnectionString %>" SelectCommand="SELECT AhwalMappingID, AhwalID, ShiftID, SectorID, PatrolRoleID, CityGroupID,(Select MilNumber From Persons where PersonID=AhwalMapping.PersonID) as MilNumber,(Select RankID From Persons where PersonID=AhwalMapping.PersonID) as RankID, (Select Name From Persons where PersonID=AhwalMapping.PersonID) as PersonName, CallerID, HasDevices, (Select Serial From HandHelds where HandHeldID=AhwalMapping.HandHeldID) as Serial,  (Select PlateNumber From PatrolCars where PatrolID=AhwalMapping.PatrolID) as PlateNumber, PatrolPersonStateID,  SortingIndex,(Select Mobile From Persons where PersonID=AhwalMapping.PersonID) as PersonMobile,IncidentID,LastStateChangeTimeStamp FROM AhwalMapping WHERE (AhwalID IN (SELECT AhwalID FROM UsersRolesMap WHERE (UserID = @UserID) AND (UserRoleID = @UserRoleID))) Order by SortingIndex">
                <SelectParameters>
                    <asp:SessionParameter Name="UserID" SessionField="UserID" />
                    <asp:SessionParameter Name="UserRoleID" SessionField="UserRoleID" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="OpsRanksDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:PatrolsConnectionString %>" SelectCommand="SELECT [RankID], [Name] FROM [Ranks]"></asp:SqlDataSource>
            <asp:SqlDataSource ID="OpsPersonDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:PatrolsConnectionString %>" SelectCommand="SELECT [PersonID], [AhwalID], [Name], [MilNumber] FROM [Persons] WHERE (AhwalID IN (SELECT AhwalID FROM UsersRolesMap WHERE (UserID = @UserID) AND (UserRoleID = @UserRoleID )))">
                <SelectParameters>
                    <asp:SessionParameter Name="UserID" SessionField="UserID" />
                    <asp:SessionParameter Name="UserRoleID" SessionField="UserRoleID" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="OpsPatrolCarDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:PatrolsConnectionString %>" SelectCommand="SELECT PatrolID, PlateNumber,Model,Type, BarCode, Defective, Rental FROM PatrolCars where (AhwalID IN (SELECT AhwalID FROM UsersRolesMap WHERE (UserID = @UserID) AND (UserRoleID = @UserRoleID )))">
                <SelectParameters>
                    <asp:SessionParameter Name="UserID" SessionField="UserID" />
                    <asp:SessionParameter Name="UserRoleID" SessionField="UserRoleID" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="OpsHandHeldDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:PatrolsConnectionString %>" SelectCommand="SELECT HandHeldID, Serial, BarCode, Defective FROM HandHelds WHERE (AhwalID IN (SELECT AhwalID FROM UsersRolesMap WHERE (UserID = @UserID) AND (UserRoleID = @UserRoleID )))">
                <SelectParameters>
                    <asp:SessionParameter Name="UserID" SessionField="UserID" />
                    <asp:SessionParameter Name="UserRoleID" SessionField="UserRoleID" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="OpsPatrolRoleDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:PatrolsConnectionString %>" SelectCommand="SELECT [PatrolRoleID], [Name] FROM [PatrolRoles]"></asp:SqlDataSource>
